...
// 获取系统日志列表
export function systemLogPage(params: any) {
  return request.get({ url: '/setting.system.log/list', params }, { ignoreCancelToken: true })
}
...
// 定时任务列表
export function crontabPage(params: any) {
  return request.get({ url: '/crontab.crontab/list', params })
}
